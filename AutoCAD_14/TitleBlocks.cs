...
namespace AutoCAD_14
{
    class TitleBlocks
    {
        ...
        public void DrawTitleBlock()
        {
            ...
            string projectNumber = pr.StringResult;
            if (projectNumber != "")
            {
                tb.ProjectNo = projectNumber;
            }
